    ...
    return (
        <>
            <div className="max-w-3xl mx-auto px-4">
                <h2 className='text-center mt-4 text-xl font-semibold text-gray-800'>Register Your Details</h2>
                <div className='bg-white shadow-lg mt-4 p-6 rounded-xl'>
                    <div className="text-center">
                        <img src={preview ? preview : "/man.png"} alt="img" className="w-12 h-12 rounded-full object-cover mx-auto" />
                    </div>
                            ...
                            <div>
                                ...
                                <div className="flex gap-4 mt-1">
                                    <label className="flex items-center gap-1.5 text-sm text-gray-700 cursor-pointer">
                                        <input type="radio" name="gender" value="Male" onChange={setInputValue} defaultChecked className="accent-blue-500" />
                                        Male
                                    </label>
                                    <label className="flex items-center gap-1.5 text-sm text-gray-700 cursor-pointer">
                                        <input type="radio" name="gender" value="Female" onChange={setInputValue} className="accent-blue-500" />
                                        Female
                                    </label>
                                </div>
                            </div>
